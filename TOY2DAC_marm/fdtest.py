...
t2dpar = {
    ...
    'fvp': 'vptest', 'fqp': 'qp_mamousi', 'frho': 'rhotest',
...
rhotest = np.ones((nx, nz), dtype=np.float32) * 2500
t2dpar['nz'] = nz
t2dpar['nx'] = nx
t2dpar['dx'] = modObj.dx
t2dpar['dz'] = modObj.dz
...
if t2dpar['toymode'] ==0:
    ...
    # toy2dac input files
    fwiprep.write_vp_rho_qp(t2dpar, vptest, rhotest) # vp, rho, qp
